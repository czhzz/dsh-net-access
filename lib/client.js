...
var Section_default = { "command": { "name": "SZesTG_command", "composes": [], "isReferenced": false }, "actions": { "name": "SZesTG_actions", "composes": [], "isReferenced": false }, "field": { "name": "SZesTG_field", "composes": [], "isReferenced": false }, "head": { "name": "SZesTG_head", "composes": [], "isReferenced": false }, "badges": { "name": "SZesTG_badges", "composes": [], "isReferenced": false }, "hint": { "name": "SZesTG_hint", "composes": [], "isReferenced": false }, "intro": { "name": "SZesTG_intro", "composes": [], "isReferenced": false }, "label": { "name": "SZesTG_label", "composes": [], "isReferenced": false }, "restartNote": { "name": "SZesTG_restartNote", "composes": [], "isReferenced": false }, "choices": { "name": "SZesTG_choices", "composes": [], "isReferenced": false }, "input": { "name": "SZesTG_input", "composes": [], "isReferenced": false }, "textarea": { "name": "SZesTG_textarea", "composes": [{ "type": "local", "name": "SZesTG_input" }], "isReferenced": false } };
