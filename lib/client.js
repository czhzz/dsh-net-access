window.__ModuleLoader__.load({ id: "dsh-remote-access", factory: (require) => { var module = { exports: {} }; var exports = module.exports;
...
var css = ".SZesTG_field{flex-direction:column;gap:8px;padding:14px 0;display:flex}.SZesTG_field+.SZesTG_field{border-top:.5px solid var(--dsw-alias-border-l2)}.SZesTG_head{align-items:center;gap:8px;min-height:24px;display:flex}.SZesTG_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:14px;font-weight:400;line-height:22px}.SZesTG_badges{align-items:center;gap:8px;display:inline-flex}.SZesTG_intro{color:var(--dsw-alias-label-secondary);margin:0 0 4px;font-size:13px;line-height:20px}.SZesTG_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:18px}.SZesTG_choices{flex-wrap:wrap;gap:6px;padding-top:2px;display:flex}.SZesTG_restartNote{color:var(--dsw-alias-state-warn-label);border-top:.5px solid var(--dsw-alias-border-l2);margin:0;padding:12px 0;font-size:12px;line-height:18px}.SZesTG_command{font-family:var(--dsh-font-mono,ui-monospace, monospace);color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-3);user-select:all;border-radius:6px;padding:1px 6px;font-size:12px;line-height:20px}.SZesTG_input{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-1);width:100%;height:32px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 10px;font-size:14px;line-height:22px}.SZesTG_input::placeholder{color:var(--dsw-alias-label-dimmed)}.SZesTG_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.SZesTG_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.SZesTG_textarea{resize:vertical;height:auto;min-height:58px;font-family:var(--dsh-font-mono,ui-monospace, monospace);padding:6px 10px;font-size:13px;line-height:20px;}.SZesTG_actions{align-items:center;gap:8px;padding-top:12px;display:flex}";
var tagId = "dsh-remote-access/Section.module.css";
...
var Section_default = { "input": { "name": "SZesTG_input", "composes": [], "isReferenced": false }, "command": { "name": "SZesTG_command", "composes": [], "isReferenced": false }, "textarea": { "name": "SZesTG_textarea", "composes": [{ "type": "local", "name": "SZesTG_input" }], "isReferenced": false }, "field": { "name": "SZesTG_field", "composes": [], "isReferenced": false }, "label": { "name": "SZesTG_label", "composes": [], "isReferenced": false }, "badges": { "name": "SZesTG_badges", "composes": [], "isReferenced": false }, "intro": { "name": "SZesTG_intro", "composes": [], "isReferenced": false }, "actions": { "name": "SZesTG_actions", "composes": [], "isReferenced": false }, "head": { "name": "SZesTG_head", "composes": [], "isReferenced": false }, "hint": { "name": "SZesTG_hint", "composes": [], "isReferenced": false }, "choices": { "name": "SZesTG_choices", "composes": [], "isReferenced": false }, "restartNote": { "name": "SZesTG_restartNote", "composes": [], "isReferenced": false } };
